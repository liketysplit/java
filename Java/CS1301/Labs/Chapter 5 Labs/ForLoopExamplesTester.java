...
//
//**********************************************
public class ForLoopExamplesTester{
   public static void main (String[] args){
      //1.  Create an object out of LoopExamples class
      //    to use its methods
      ForLoopExamples le = new ForLoopExamples(); //no-argument constructor
      ...
      //    to use its methods
      ForLoopExamples le2 = new ForLoopExamples("Rick Boles","CS1301A"); 
